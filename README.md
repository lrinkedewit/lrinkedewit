...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?color=%101c9ef7&size=28&duration=3400&width=1000&lines=Welcome+to+my+GitHub,+home+to+all+my+inventions.;Back+end+dev,+comfortable+across+the+stack.;Developer+on+Mist,+observability+tool+for+serverless.;Based+in+Amsterdam,+but+working+where+software+takes+me.)](https://git.io/typing-svg)
